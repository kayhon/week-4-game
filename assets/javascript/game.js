...
//the number generated @ the begining of each round by the machine between 12-120 - this is a function or a process that I want the computer run over and over. Write the function in javascript and call it in jQuery - although in terms of syntax the jQuery goes before the javascript
(document).ready(function(){
    ...
    //this is getting the buttons to work.  append each variable with jQuery so html can use it. Give each button an onclick function so it will activate when the user clicks on the image, then define the function you want the machine to perform - which is adding the image # with the total score #.
